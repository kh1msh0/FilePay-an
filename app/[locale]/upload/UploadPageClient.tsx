...
export default function UploadPageClient({ params: { locale } }: { params: { locale: string } }) {
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2 animate-slide-up animate-stagger-4 opacity-0">
                    ...
                    <Input
                      id="email"
                      type="email"
                      placeholder={t("upload.form.emailPlaceholder")}
                      required
                ...
                >
                  {copied ? (
                    <>
                      ...
                      {t("upload.success.copied")}
                    </>
                  ) : (
                    <>
                      <Copy className="w-4 h-4 mr-2" />
                      {t("upload.success.copy")}
                    </>
                  )}
                </Button>
              </CardContent>
