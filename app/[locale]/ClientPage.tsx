...
export default function ClientHomePage({ params: { locale } }: { params: { locale: string } }) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-200 dark:border-blue-800 rounded-full px-4 py-2 mb-6 animate-bounce-in animate-stagger-1 opacity-0">
            ...
            <span className="text-sm font-medium text-blue-700 dark:text-blue-300">{t("home.badge")}</span>
          </div>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-yellow-50 to-orange-100 dark:from-yellow-900/20 dark:to-orange-900/20 hover:shadow-xl transition-all duration-300">
            <CardHeader>
              <Quote className="w-8 h-8 text-yellow-600 dark:text-yellow-400 mb-2" />
            </CardHeader>
            <CardContent>
              <blockquote className="text-gray-700 dark:text-gray-300 mb-4 italic">
                "{t("home.success.story1.quote")}"
              </blockquote>
              <cite className="text-sm font-semibold text-yellow-700 dark:text-yellow-300">
                {t("home.success.story1.name")}
              </cite>
            </CardContent>
          </Card>

          <Card className="border-0 shadow-lg bg-gradient-to-br from-pink-50 to-rose-100 dark:from-pink-900/20 dark:to-rose-900/20 hover:shadow-xl transition-all duration-300">
            <CardHeader>
              <Quote className="w-8 h-8 text-pink-600 dark:text-pink-400 mb-2" />
            </CardHeader>
            <CardContent>
              <blockquote className="text-gray-700 dark:text-gray-300 mb-4 italic">
                "{t("home.success.story2.quote")}"
              </blockquote>
              <cite className="text-sm font-semibold text-pink-700 dark:text-pink-300">
                {t("home.success.story2.name")}
              </cite>
            </CardContent>
          </Card>

          <Card className="border-0 shadow-lg bg-gradient-to-br from-indigo-50 to-purple-100 dark:from-indigo-900/20 dark:to-purple-900/20 hover:shadow-xl transition-all duration-300">
            <CardHeader>
              <Quote className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mb-2" />
            </CardHeader>
            <CardContent>
              <blockquote className="text-gray-700 dark:text-gray-300 mb-4 italic">
                "{t("home.success.story3.quote")}"
              </blockquote>
              <cite className="text-sm font-semibold text-indigo-700 dark:text-indigo-300">
                {t("home.success.story3.name")}
              </cite>
            </CardContent>
          </Card>
        </div>
